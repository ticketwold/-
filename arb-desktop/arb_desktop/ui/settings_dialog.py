...
class SettingsDialog(QDialog):
    def __init__(self, settings: AppSettings, parent=None) -> None:
        ...
        self.chk_parallel_dry = QCheckBox("READY 드라이런 병렬")
        self.chk_parallel_live = QCheckBox("실제 병렬 실행")
        ...
        form.addRow("원화 반올림", self.combo_round_krw)
        form.addRow("USDT 반올림", self.combo_round_usdt)
